...
check("all 10 files stamp 5.32", not missing, "missing: %s" % ", ".join(missing))
...
check("no 5.27/5.28/5.29/5.30/5.31 property stamp survives", not stale, "stale: %s" % ", ".join(stale))
