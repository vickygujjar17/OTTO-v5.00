//+------------------------------------------------------------------+
//|                                                   OttoDefines.mqh |
//|             OTTO EA v5.22 — 28-Pair Institutional Master Build |
...
#property description "OTTO v5.22 — Goat Funded Trader (GFT) Master Build (Wick1+Wick2 | Separation | Front-Run | Near-Miss | Stale Vetoes)"
